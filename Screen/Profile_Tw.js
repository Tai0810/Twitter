                        ...
                        return (
                            <View>
                                <View style={{ width: '100%', marginLeft: '20px', marginTop: '10px' }}>
                                    <View style={{ flexDirection: 'row', marginLeft: '55px', }}>
                                        <Image
                                            style={{ width: '9.73px', height: '11.73px', marginTop: '3px' }}

                                            source={require('../assets/Pin Solid Icon.svg')}
                                        />
                                        <Text style={{ color: 'gray', marginLeft: '8px' }}>
                                            Ghim
                                        </Text>
                                    </View>
                                    <View style={{ flexDirection: 'row' }}>
                                        <Image
                                            style={{ width: '55px', height: '55px', marginTop: '3px', borderColor: 'white', borderRadius: '50%', borderWidth: '3px' }}
                                            source={user.avatar}
                                        />
                                        <View>
                                            <View style={{ flexDirection: 'row' }}>
